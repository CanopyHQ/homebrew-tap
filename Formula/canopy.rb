class Canopy < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/CanopyHQ/canopy/releases/download/v1.0.0/canopy-darwin-arm64.tar.gz"
      sha256 "d0f916be32c4bdf682e8e87f8458e00d309c42cf6d6227db233a6443929b564f"
    else
      url "https://github.com/CanopyHQ/canopy/releases/download/v1.0.0/canopy-darwin-amd64.tar.gz"
